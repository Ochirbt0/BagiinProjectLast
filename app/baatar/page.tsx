...
export default function BaatarPage() {
  ...
  const [heroesLockedMap, setHeroesLockedMap] = useState<
            ...
            return (
              <div key={rankIndex}>
                ...
                <div className="flex items-center gap-3 mb-8 border-b border-gray-100 pb-5">
                  ...
                  <div>
                    <h2 className="text-xl md:text-2xl font-[1000] text-[#5D3191] uppercase italic leading-none">
                      {rank.rankName}
                    </h2>
                    <p
                      className={`text-[9px] font-black uppercase mt-1 ${isRankLocked ? "text-red-400" : "text-[#8DC63F]"}`}
                    >
                      {isRankLocked
                    ...
                    return (
                      ...
                      >
                        <div
                          onClick={() =>
                            handleSelectHero(
                              { ...hero, name: heroName, src: heroSrc },
                              isHeroLocked,
                            )
                          }
                          className={`
                        ...
                        >
                          ...
                          <div className="text-center">
                            <h3
                              className={`font-black text-[10px] md:text-[11px] uppercase mb-4 truncate transition-colors ${isHeroLocked ? "text-gray-400" : "text-[#5D3191] group-hover:text-[#8DC63F]"}`}
                            >
                              {heroName}
                            </h3>
                            <button
                              className={`w-full py-2.5 rounded-2xl text-[9px] font-black uppercase transition-all ${
                                isHeroLocked
                                  ...
                                  : "bg-[#5D3191] text-white group-hover:bg-[#8DC63F] group-hover:shadow-lg"
                              }`}
                            >
